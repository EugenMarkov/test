"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[714],{37714:(e,t,i)=>{i.r(t),i.d(t,{W3mModal:()=>h});var o=i(63685),a=i(30052),s=i(56545),r=i(57521);let n=(0,s.iv)`
  :host {
...
`;var l=i(94653),c=function(e,t,i,o){var a,s=arguments.length,r=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(r=(s<3?a(r):s>3?a(t,i,r):a(t,i))||r);return s>3&&r&&Object.defineProperty(t,i,r),r};let d="scroll-lock",h=class extends s.oi{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=o.IN.state.open,this.caipAddress=o.RY.state.activeCaipAddress,this.caipNetwork=o.RY.state.activeCaipNetwork,this.isSiweEnabled=o.OptionsController.state.isSiweEnabled,this.shake=o.IN.state.shake,this.initializeTheming(),o.ApiController.prefetch(),this.unsubscribe.push(o.IN.subscribeKey("open",e=>e?this.onOpen():this.onClose()),o.IN.subscribeKey("shake",e=>this.shake=e),o.Ni.subscribeKey("siweStatus",e=>this.onSiweStatusChange(e),"eip155"),o.RY.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),o.RY.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),o.OptionsController.subscribeKey("isSiweEnabled",e=>this.isSiweEnabled=e)),o.Xs.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?(0,s.dy)`
        ...
        `:null}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){let e="ConnectingSiwe"===o.RouterController.state.view,t="ApproveTransaction"===o.RouterController.state.view;if(this.isSiweEnabled){let{SIWEController:a}=await i.e(196).then(i.bind(i,54166));"success"!==a.state.status&&(e||t)?o.IN.shake():o.IN.close()}else o.IN.close()}initializeTheming(){let{themeVariables:e,themeMode:t}=o.ThemeController.state,i=a.UiHelperUtil.getColorTheme(t);(0,a.initializeTheming)(e,i)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),o.SnackController.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){let e=document.createElement("style");e.dataset.w3m=d,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
